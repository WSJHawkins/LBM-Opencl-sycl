        ...
        device_queue.submit([&](sycl::handler &cgh){
          ...
          cgh.parallel_for<class lbm1>( myRange, [=] (sycl::nd_item<2> item){
            ...
            ** scratch space grid */
            ...
            const float local_density_recip = sycl::native::recip(local_density);
            ...
            /* velocity squared */
            const float temp2 = - (u_x * u_x + u_y * u_y)* sycl::native::recip((2.f * c_sq));
            ...
            /* local density total */
            local_density =  sycl::native::recip((tmp_s0 + tmp_s1 + tmp_s2 + tmp_s3 + tmp_s4 + tmp_s5 + tmp_s6 + tmp_s7 + tmp_s8));
